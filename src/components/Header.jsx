...
// se quiser migrar para HashRouter de fato, descomente e troque <a> por <Link>
...
export default function Header({ onToggleTheme, isAuthed, onLogout }) {
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-neutral-200 dark:border-neutral-800 backdrop-blur bg-neutral-50/70 dark:bg-neutral-950/70">
